...
/* cohere用 HTTP POST */
app.post("https://gemini-voicevox.vercel.app/cohere", async (req, res) => {
...
/* VOICEVOX用 HTTP POST */
app.post("https://gemini-voicevox.vercel.app/voicevox", async (req, res) => {
...
app.post("https://gemini-voicevox.vercel.app/local/voicevox", async (req, res) => {
